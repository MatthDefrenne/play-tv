...
/**
 * UkDotPlayDotTvUrlMatcher.
 *
 * This class has been auto-generated
 * by the Symfony Routing Component.
 */
class UkDotPlayDotTvUrlMatcher extends Symfony\Component\Routing\Matcher\UrlMatcher
{
    /**
     * Constructor.
     */
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/on-demand-video')) {
            // replay_replay
            if (preg_match('#^/on\\-demand\\-video/(?P<video_id>[^/]++)/(?P<title>[^/]++)/$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'replay_replay')), array (  '_controller' => 'replay_tv_controller::replay_action',  'bundle' => 'replay',));
            }

            // replay_replay_no_title
            if (preg_match('#^/on\\-demand\\-video/(?P<video_id>[^/]++)/$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'replay_replay_no_title')), array (  '_controller' => 'replay_tv_controller::replay_action',  'title' => NULL,  'bundle' => 'replay',));
            }

        }

        if (0 === strpos($pathinfo, '/catchup-tv')) {
            if (0 === strpos($pathinfo, '/catchup-tv/videos')) {
                // replay_channel_videos
                if (preg_match('#^/catchup\\-tv/videos/(?P<channel_id>[^/]++)/(?P<channel_alias>[^/]++)/$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'replay_channel_videos')), array (  '_controller' => 'replay_tv_controller::videos_action',  'bundle' => 'replay',));
                }

                // replay_videos
                if ($pathinfo === '/catchup-tv/videos/') {
