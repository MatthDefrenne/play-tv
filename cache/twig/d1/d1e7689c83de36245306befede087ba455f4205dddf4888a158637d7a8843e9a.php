...
/* controllers/errors/not-found.twig */
class __TwigTemplate_7f6ee2359ba5bb164a39f27cd8456fcd64b816467bf8cbb0f78f52831feb3be0 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layouts/full.twig", "controllers/errors/not-found.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"container\">
      <div class=\"row\">
        ...
        // line 9
        echo $this->env->getExtension('translator')->getTranslator()->trans("%status_code% ERROR", array("%status_code%" => 404), "messages");
        echo "</h1>
...
";
    ...
    {
        return "controllers/errors/not-found.twig";
    }
...
/*         <div class="span16 ptv-Error404">*/
/*           <div class="page-title ptv-Error404Header">*/
/*             <h1 class="ptv-Error404Header-heading">{% trans with {'%status_code%':404} %}%status_code% ERROR{% endtrans %}</h1>*/
